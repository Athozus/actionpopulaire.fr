...
EMAIL_TEMPLATES = {
    ...
    # GROUP_SOMEONE_JOINED_MESSAGE" variables: MESSAGE_LINK
    "GROUP_SOMEONE_JOINED_MESSAGE": "https://mosaico.lafranceinsoumise.fr/emails/abe22680-0a26-4533-a08d-48d245b96880.html",
    # GROUP_WELCOME_MESSAGE" variables: GROUP_NAME AUTHOR_STATUS MESSAGE_HTML MESSAGE_LINK
    "GROUP_WELCOME_MESSAGE": "https://mosaico.lafranceinsoumise.fr/edit/a9e688b0-d013-44a0-9af5-991789e3125a",
...
DONATION_MAXIMUM = 7500 * 100  # 4600 €
...
NUNTIUS_MAX_SENDING_RATE = int(os.environ.get("NUNTIUS_MAX_SENDING_RATE", 170))
NUNTIUS_MAX_CONCURRENT_SENDERS = int(
    os.environ.get("NUNTIUS_MAX_CONCURRENT_SENDERS", 16)
)
NUNTIUS_MAX_MESSAGES_PER_CONNECTION = int(
    os.environ.get("NUNTIUS_MAX_MESSAGES_PER_CONNECTION", 500)
)
NUNTIUS_POLLING_INTERVAL = int(os.environ.get("NUNTIUS_POLLING_INTERVAL", 1))
...
NUNTIUS_PERFORMANCE = {"CAMPAIGN_SENT_EVENT_DISABLE_FULL_PAGINATION": ADMIN_PRODUCTION}
...
try:
    ...
    BLACK_LIST_DF = black_list_data_frame
    # refacto event black list words with same mixin logic, as Person, SupportGroup..
